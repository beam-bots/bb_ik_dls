...
## [v0.6.0](https://github.com/beam-bots/bb_ik_dls/compare/v0.5.0...v0.6.0) (2026-08-22)
### Breaking Changes:

* match bb's synchronous `set_position` changes (#86) by James Harton
...
* use bb's analytical Jacobian instead of finite differences (#52) by James Harton
